                    ...
                    <div class="col-lg-12">
                        <div class="white_card_header">
                            <div class="box_header m-0">
                                <div class="main-title">
                                    <h3 class="m-0">FORM TAMBAH DATA PELANGGAN</h3>
                                </div>
                            </div>
                        </div>
                        <div class="white_card_body QA_section">
                            <div class="QA_table ">
                                ...
                                <form action="{{ url('admin/pelanggan/add') }}" method="post">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="modal-header">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="latmodal" readonly
                                                    placeholder="Latitude" style="width: 100% !important;">
                                            </div>
                                            <div class="col-md-3">
                                                <label for="">Longitude</label>
                                                <input type="text" class="form-control" id="lngmodal" readonly
                                                    placeholder="Latitude" style="width: 100% !important;">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="">Alamat</label>
                                                <input type="text" class="form-control" id="alamatmodal" readonly
                                                    placeholder="Alamat" style="width: 100% !important;">
                                            </div>
                                        </div>
                                    </div>
