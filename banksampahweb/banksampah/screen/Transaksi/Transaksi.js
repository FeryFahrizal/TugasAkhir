...
const Transaksi = ({navigation}) => {
	...
	async function ambilData(){
		...
		const userId = await AsyncStorage.getItem('pelanggan');
		fetch(`${PELANGGAN_API}/transaksi/${userId}`)
	  ...
	  function renderData({item}){
		 return(
			<TouchableOpacity
				...
				className="p-6 border-b-2 border-b-slate-300 flex flex-row items-center justify-between"
				>
				<View>
